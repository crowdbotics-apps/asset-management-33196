...
## Project Structure
    ...
    ├── asset_management_33196  # Django project configurations
...
1. Clone this repo and `cd asset_management_33196`
...
2. Clone this repo and `cd asset_management_33196`
